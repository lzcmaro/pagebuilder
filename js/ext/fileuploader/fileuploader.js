...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        // messages
        messages: {
            typeError: "{file} 格式不对。 允许上传的文件格式为： {extensions}.", //"{file} has an invalid extension. Valid extension(s): {extensions}.",
            sizeError: "{file} 太大了， 允许上传的文件大小最大为： {sizeLimit}.", //"{file} is too large, maximum file size is {sizeLimit}.",
            minSizeError: "{file} 太小了，允许上传的文件大小最小为： {minSizeLimit}.", //"{file} is too small, minimum file size is {minSizeLimit}.",
            emptyError: "{file} 是空的（可能为快捷方式），请重新选择有效文件。", //"{file} is empty, please select files again without it.",
            noFilesError: "没有可上传文件。", //"No files to upload.",
            onLeave: "文件上传中，可点击“取消”中断。" //"The files are being uploaded, if you leave now the upload will be cancelled."
        },
